        ...
        <div class="btns">
            <div v-if="!isMiniprogram" class="btns_container">
                <div v-for="(btn, idx) in btnsConfig" :key="btn.name" class="btn_item"
                    ...
                    <div class="item_box">
                        <img v-show="btn.name == currBtnName" src="../images/close.png" alt="" />
                        <img v-show="btn.name != currBtnName" src="../images/close.png" alt="" />
            ...
            return [
                {
                    name: "分享",
                    class: "share",
                    icon: "images/alone/m/分享.png",
                    activeIcon: "images/alone/m/分享_选中.png",
                },
                {
                    name: "立即预订",
                    class: "book",
                    icon: "images/alone/m/立即预订.png",
                    activeIcon: "images/alone/m/立即预订_选中.png",
                    url: `gac://order_now?id=${goodId}`,
                },
                {
                    name: "预约试驾",
                    class: "drive",
                    icon: "images/alone/m/预约试驾.png",
                    activeIcon: "images/alone/m/预约试驾_选中.png",
                ...
                },
                {
                    name: "参数配置",
                    class: "config",
                    icon: "images/alone/m/参数配置.png",
                    activeIcon: "images/alone/m/参数配置_选中.png",
                ...
                },
                {
                    name: "在线客服",
                    class: "consults",
                    icon: "images/alone/m/客服咨询.png",
                    activeIcon: "images/alone/m/客服咨询_选中.png",
                    url: "gac://ntalker",
                },
            ];
        },
    ...
    .buttom_menu {
        ...
        .btns {
            ...
            .btns_container {
                ...
                height: 100%;
                display: flex;
                background-image: url("../images/main_bottom_menu_bg.png");
                background-size: 300%;
